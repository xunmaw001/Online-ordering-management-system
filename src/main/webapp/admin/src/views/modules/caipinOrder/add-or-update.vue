        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='address'">
                    <el-form-item class="select" v-if="type!='info'"  label="送餐地址" prop="addressId">
                        <el-select v-model="ruleForm.addressId" :disabled="ro.addressId" filterable placeholder="请选择送餐地址" @change="addressChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='address' ">
                    <el-form-item class="input" v-if="type!='info'"  label="取餐人" prop="addressName">
                        <el-input v-model="addressForm.addressName"
                                  placeholder="取餐人" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="取餐人" prop="addressName">
                            <el-input v-model="ruleForm.addressName"
                                      placeholder="取餐人" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='address' ">
